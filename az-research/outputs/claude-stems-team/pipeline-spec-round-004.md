...
Status (round 5): 44.1 kHz stereo/mono static map with end trimming and synthesis Nyquist init now decoded; ONE static hypothesis remains (pffft ordered layout/scale, U1). DYNAMIC-VALIDATION-PENDING. No runtime equivalence is claimed.
